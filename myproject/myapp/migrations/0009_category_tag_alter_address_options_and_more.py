...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='store',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stores', to='myapp.category'),
        ),
        migrations.AddField(
            model_name='store',
            name='tags',
        ...
        migrations.AddIndex(
            model_name='store',
            index=models.Index(fields=['name', 'category', 'is_active'], name='myapp_store_name_ad454e_idx'),
        ),
        migrations.AddIndex(
            model_name='tag',
